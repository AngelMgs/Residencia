    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm">
          ...
          <div class="row">
            <input type="text" name="hrp_info-g" class="form-control">
          </div>
...
<div class="row">
  ...
  <br>
          ...
          <div class="row">
            ...
            <div class="col-sm">
              <p class="text-center">
                <input type="text" name="hrp_nombre" class="form-control" placeholder="Nombre del Alumno"><br>
              </p>
            </div>
...
<script>
    ...
    document.getElementById("hrp_es").value ="Tuxtla Gutiérrez, Chiapas, a "+ day +" de "+ month +" del "+year;
</script>
@endsection