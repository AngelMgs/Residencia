    ...
    <main>
        ...
        <div class="container">
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        <th><b>DATOS DEL ALUMNO</b></th>
                    </tr>
                </thead>
                <tbody>
                <tr>
                    <td>NOMBRE DEL ALUMNO(A): {{$info['hrp_nombre']}}</td>
                </tr>
                <tr>
                    <td>SM Y GRUPO: {{$info['hrp_smgrupo']}}</td>
                </tr>
                <tr>
                    <td>HORA: {{$info['hrp_hora']}}</td>
                </tr>
                <tr>
                    <td>TUTOR: {{$info['hrp_tutor']}}</td>
                </tr>
                <tr>
                    <td>TELFONO: {{$info['hrp_telefono']}}</td>
                </tr>
            ...
            <table class="table table-bordered">
                <thead>
                    <tr>
                        ...
                        <th><b>SITUACION O MOTIVO</b></th>
                    </tr>
                </thead>
                <tbody>
                <tr>
                    
                    <td>{{$info['hrp_situacion_motivos']}}</td>
                </tr>
