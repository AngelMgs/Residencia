    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm">
          ...
          <div class="row">
            <input type="text" name="hrp_info-g" class="form-control" value="{{$info['hrp_info-g']}}" readonly>
          </div>
          de la <b>Escuela Preparatoria No. 7 del Estado</b>, con la finalidad de diagnosticar y apoyar al citado educando, a dar seguimiento en su situación particular de encontrarse en el consumo de sustancias nocivas para la salud,
        </div>
      </div>
...
<div class="row">
  ...
  <br>
          ...
          <div class="row">
            ...
            <div class="col-sm">
              <p class="text-center">
                <input type="text" name="hrp_nombre" class="form-control" placeholder="Nombre del Alumno" value="{{$info['hrp_nombre']}}" readonly><br>
                <p class="text-center">
                  <b>A L U M N O</b><br>
