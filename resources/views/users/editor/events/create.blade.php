            ...
            <div class="col-md-12">
                <div class="block p-6 rounded-lg shadow-full bg-white max-h-full max-w-full">
                  <header class="px-5 py-4 border-b border-gray-100">
                    <div class="font-semibold text-gray-800">Agregar Nuevo Evento</div>
                  </header>
                    <form action="{{ route('events.store') }}" method="post" class="form-horizontal" id="form1">
                        @csrf
                        <div class="form-group mb-6">
                          ...
                          <button type="submit" class="
                            ...
                            transition
                            duration-150
                            ease-in-out">Agregar Nuevo Anuncio</button> 
